...
+ Fix compile warnings for spring-security-config [#18419](https://github.com/spring-projects/spring-security/pull/18596)
  + A code quality improvement initiative to identify and resolve all compilation warnings that occur during the build process
  + Experience with open-source workflows through code reviews with global maintainers
